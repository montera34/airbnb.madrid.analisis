...
data_long <- todos
data_long$fechab <- as.Date( data_long$date, "%Y-%m-%d")

# has license --------
# table(data_long$calculated_host_listings_count)
data_long$license <- as.character(data_long$license)
# has license
data_long$has.license <- ifelse(data_long$license == "", "sin licencia", "con licencia")
...
dates.count  %>%
  ...
  annotate("rect", alpha = .07,
           ...
           ymax = Inf) +
  # verano
  annotate(geom = "text", x = as.Date("2015-08-06"), y = 2000, label = "Verano", 
  ...
  labs(title = "Número de anuncios de Airbnb en cada descarga de datos de InsideAirbnb",
       ...
       caption = caption) +
  # nota
  annotate(geom = "text", x = as.Date("2017-06-1"), y = 6500, label = "Cada punto es un scraping de InsideAirbnb", 
  ...
  # color="#999999") +
  geom_curve(aes(x = as.Date("2017-06-01"), y = 6500, xend = as.Date("2018-01-15"), yend = 15900), 
...
png(filename=paste("images/airbnb/evolucion/anuncios-",local_basic,"-por-mes-linea-license.png", sep = ""),width = 1000,height = 400)
ggplot(NULL) + 
  geom_text_repel(data= haslicense %>% filter(fechab > maxdate-1 & !is.na(has.license) ),
  ...
  geom_line(data= haslicense %>% filter(!is.na(has.license) ),
...
haslicense.roomtype <- data_long %>% group_by(fechab,has.license,room_type.s) %>% summarise(anuncios=n()) %>% filter( !is.na(has.license)  )
...
haslicense.hosttype <- data_long %>% group_by(fechab,has.license,host.type) %>% summarise(anuncios=n())  %>% filter( !is.na(has.license)  )
...
ggplot(NULL) + 
  ...
  geom_text_repel(data=filter(haslicense.hosttype, fechab > maxdate-1),
                  aes(fechab+50,anuncios,label=paste(format(anuncios, nsmall=1, big.mark=".") , sep = "")), 
                  nudge_x = 35, # adjust the starting y position of the text label
                  size=4,
                  hjust=0,
                  family = "Roboto Condensed",
...
# A
haslicense.hosttype.roomtype <- data_long %>% group_by(fechab,has.license,host.type,room_type.s) %>% summarise(anuncios=n())  %>% filter( !is.na(has.license)  )
...
ggplot(NULL) + 
  ...
  geom_text(data=filter(dates.count,fechab > as.Date("2019-03-01")),
            aes(fechab+100,anuncios,label=format(anuncios, nsmall=1, big.mark=".")), size=4,hjust=0) +
...
png(filename=paste("images/airbnb/evolucion/anuncios-por-mes-room-type.png", sep = ""),width = 1000,height = 400)
...
# timeline
png(filename=paste("images/airbnb/evolucion/anuncios-por-mes-host-type.png", sep = ""),width = 1000,height = 400)
...
# timeline
png(filename=paste("images/airbnb/evolucion/anuncios-por-mes-host-type-1-2-3-more.png", sep = ""),width = 1000,height = 400)
dates.count.host.type.m %>%
  ...
  annotate("rect", alpha = .07,
           ...
           ymax = Inf) +
  # verano
  annotate(geom = "text", x = as.Date("2015-08-06"), y = 7000, label = "Verano", 
           family = "Roboto Condensed", hjust = 0.5, size=5, color="#888888") +
  # annotate("text",x=as.Date("2018-05-28"),y=4000,label="acuerdo",color="#000000",size=5,hjust=1,family = "Roboto Condensed") +
...
# timeline
png(filename=paste("images/airbnb/evolucion/anuncios-por-mes-host-room-type.png", sep = ""),width = 1000,height = 400)
...
# timeline
png(filename=paste("images/airbnb/evolucion/anuncios-por-mes-host-m-room-type.png", sep = ""),width = 1000,height = 400)
...
png(filename=paste("images/airbnb/evolucion/anuncios-por-mes-barrio.png", sep = ""),width = 1000,height = 700)
...
dates.count.barrio.license <- data_long %>% group_by(fechab,neighbourhood_cleansed,has.license,neighbourhood_group_cleansed) %>% summarise(anuncios=n()) %>% 
  filter(!is.na(has.license))

png(filename=paste("images/airbnb/evolucion/anuncios-por-mes-barrio-license.png", sep = ""),width = 1300,height = 700)
dates.count.barrio.license %>%
  ...
  geom_text_repel(data=filter(dates.count.barrio.license,fechab==as.Date("2019-03-08"),anuncios>200), 
                  ...
                  segment.size = 0.2,
                  segment.color="#333333",
                  xlim  = c(as.Date(max(dates.count.barrio.license$fechab)),as.Date("2020-06-4"))
  ) +
  ...
  scale_x_date(
    date_breaks = "1 year",
    limits = c(as.Date(min(dates.count.barrio.license$fechab)),as.Date("2020-01-4")),
    date_labels = "%Y"
  ) +
...
png(filename=paste("images/airbnb/evolucion/anuncios-por-mes-barrio-license-room.png", sep = ""),width = 1100,height = 800)
...
# C.2 counts listings por distrito y license y room type--------------------------------------------------------------
...
# C.2.A -------------------------------
png(filename=paste("images/airbnb/evolucion/anuncios-por-mes-distrito-license-room.png", sep = ""),width = 1300,height = 800)
dates.count.distrito.license.room %>% 
  ...
  labs(title = "Número de anuncios de Airbnb por distrito, si tiene licencia y tipo de alojamiento en Madrid",
       subtitle = paste( local_name, " ", period, sep=""),
       y = "número de anuncios",
       x = "",
       caption = caption) +
...
png(filename=paste("images/airbnb/evolucion/anuncios-por-mes-distrito-license-room-variosanuncios.png", sep = ""),width = 1100,height = 800)
dates.count.distrito.license.room.varios %>% 
  ...
  scale_color_manual(values = getPalette(colourCountdistrict)) +
  # barrios labels
  geom_text_repel(data=filter(dates.count.distrito.license.room.varios,fechab==as.Date("2019-03-08"),anuncios>200), 
                  aes(fechab+5,anuncios,label=paste(anuncios,neighbourhood_group_cleansed)),
                  nudge_x = 35, # adjust the starting y position of the text label
                  size=4,
                  hjust=0,
                  ...
                  segment.size = 0.2,
                  segment.color="#333333",
                  xlim  = c(as.Date(max(dates.count.distrito.license.room.varios$fechab)),as.Date("2021-06-4"))
  ) +
  ...
  labs(title = "Número de anuncios de Airbnb por distrito, si tiene licencia y tipo de alojamiento en Madrid. Hosts con varios anuncios",
       subtitle = paste( local_name, " ", period, sep=""),
       y = "número de anuncios",
       x = "",
       caption = caption) +
...
png(filename=paste("images/airbnb/evolucion/anuncios-por-mes-distrito-license-room-1anuncio.png", sep = ""),width = 1100,height = 800)
dates.count.distrito.license.room.uni %>% 
  ...
  # barrios labels
  geom_text_repel(data=filter(dates.count.distrito.license.room.uni,fechab==as.Date("2019-03-08"),anuncios>200), 
                  aes(fechab+5,anuncios,label=paste(anuncios,neighbourhood_group_cleansed)),
                  nudge_x = 35, # adjust the starting y position of the text label
                  size=4,
                  hjust=0,
                  ...
                  segment.size = 0.2,
                  segment.color="#333333",
                  xlim  = c(as.Date(max(dates.count.distrito.license.room.uni$fechab)),as.Date("2021-06-4"))
  ) +
  scale_y_continuous(limits=c(0, max(dates.count.distrito.license.room.varios$anuncios)),labels=function(x) format(x, big.mark = ".", scientific = FALSE)) +
  ...
  labs(title = "Número de anuncios de Airbnb por distrito, si tiene licencia y tipo de alojamiento en Madrid. Hosts con 1 anuncio",
       subtitle = paste( local_name, " ", period, sep=""),
       y = "número de anuncios",
       x = "",
       caption = caption) +
...
# counts listings por barrio y room type--xxxxx------------------------------------------------------------
dates.count.barrio.room <- data_long %>% group_by(fechab,neighbourhood_cleansed,room_type.s,neighbourhood_group_cleansed) %>% summarise(anuncios=n()) 

png(filename=paste("images/airbnb/evolucion/anuncios-por-mes-barrio-room.png", sep = ""),width = 1300,height = 700)
dates.count.barrio.room %>% 
  ...
  scale_x_date(
    date_breaks = "1 year",
    limits = c(as.Date(min(dates.count.barrio.room$fechab)),as.Date("2020-01-4")),
    date_labels = "%Y"
  ) +
...
png(filename=paste("images/airbnb/evolucion/anuncios-por-mes-barrio-room-reviews.png", sep = ""),width = 1100,height = 800)
dates.count.barrio.room.reviews %>% 
  ...
  labs(title = "Tipo alojamiento vs nº reviews por barrio en Madrid",
       subtitle = paste( local_name, " ", period, sep=""),
       y = "número de anuncios",
       x = "",
       caption = caption) +
...
dates.count.barrio.host %>%
  ...
  scale_color_manual(values = getPalette(colourCount)) +
  # barrios labels
  geom_text_repel(data=filter(dates.count.barrio.host,fechab==as.Date("2019-03-08"),anuncios>200), 
                  aes(fechab+5,anuncios,label=paste(anuncios,neighbourhood_cleansed)),
                  nudge_x = 35, # adjust the starting y position of the text label
                  size=4,
                  hjust=0,
...
# counts listings por barrio y host type y reviews- TODO-------------------------------------------------------------
dates.count.barrio.host.reviews <- data_long %>% group_by(fechab,neighbourhood,host.type,reviews.type) %>% 
  summarise(anuncios=n()) %>% filter(!reviews.type=="")

png(filename=paste("images/airbnb/evolucion/anuncios-por-mes-barrio-host-reviews.png", sep = ""),width = 1000,height = 600)
dates.count.barrio.host.reviews %>% 
  ...
  labs(title = "Número de anuncios de Airbnb por barrio, tipo de host y nº reviews en Madrid",
       subtitle = paste( local_name, " ", period, sep=""),
       y = "número de anuncios",
       x = "",
       caption = caption) +
...
data_long %>% filter(neighbourhood == "la Dreta de l'Eixample" ) %>%
  ...
  labs(title = "Número de reviews por anuncio en Madrid",
