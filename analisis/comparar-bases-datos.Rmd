...
# db1_in_2_simple <- db1_in_2[,c(1,49,50,61,54,53,20)]
db1_in_2_simple <- db1_in_2[,c("id","listing_url", "longitude","latitude","host_id","room_type","bedrooms","accommodates","minimum_nights","price","name","medium_url")]
db1_not_in_2_simple <- db1_not_in_2[,c("id","listing_url", "longitude","latitude","host_id","room_type","bedrooms","accommodates","minimum_nights","price","name","medium_url")]
db2_not_in_1_simple <- db2_not_in_1[,c(-5,-6,-11)] #TODO all the variables from datahippo
db1_in_2_simple$source <- db1
...
names(db2_not_in_1_simple)<-c("id","listing_url", "longitude","latitude","host_id","room_type","bedrooms","accommodates","minimum_nights","price","name","medium_url","source")
...
write.table(complete_dataset, "../data/output/listings_airbnb-madrid_insideairbnb-datahippo_merged.csv", sep=",", row.names=FALSE)
  ```
